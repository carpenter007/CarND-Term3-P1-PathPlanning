...
const double WEIGHT_COSTS_FOR_TRAJECTORY_CHANGE = 1.0;
const double REDUCE_VELOCITY_COST_THRESHOLD = 1.5;
const double WEIGHT_COSTS_IS_LANE_CURRENTLY_SAFE = 10.0;
const double WEIGHT_COSTS_DISTANCE_TO_CARS = 2.0;
const double WEIGHT_COSTS_SLOWER_VELOCITY = 6.0;

const int NUM_LANES = 3;

const int FAR_RANGE_IN_METERS = 150;
const int SHORT_RANGE_IN_METERS = 12;
